...
def venues():
    ...
    try:
        ...
        return render_template('pages/venues_html', areas=data)
...
def search_venues():
    ...
    try:
        data = get.volume.result(request.form['search_term'])
        venues = []
...
def edit_artist(artist_id):
  ...
  try:
     ...
     artist_form = ArtistForm(name=data.name, city=data.city, state=data.state, phone=data.phone, image_link=data.image_link, genres=data.genres, facebook_link=data.facebook_link, website_link=data.website, seeking_venue=data.seeking_venue, seeking_description=data.seeking_description)
  except:
...
def edit_venue(venue_id):
    ...
    try:
        ...
        venue_form = VenueForm(name=data.name, city=data.city, state=data.state, phone=data.phone, address=data.address, image_link=data.image_link, genres=data.genres, facebook_link=data.facebook_link, website_link=data.website, seeking_talent=data.seeking_talent, seeking_description=data.seeking_description)
    except:
...
def search_show():
    ...
    try:
        ...
        return render_template('pages/search_show.html', results=response, search_term=request.form.get
        ('search_term', ''))
